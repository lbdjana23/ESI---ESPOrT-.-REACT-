                        ...
                        <div className="card mx-auto">
                            <div className="card-body">
                                <div className=" d-flex flex-row justify-content-between mt-2 pt-1">
                                    <Link to="/homepage-not-squad"><img src={home2} alt="home-2"/><span class="d-block">Home</span></Link>
                                    <Link to="/tournament"><img src={tournament1} alt="tournament-1"/><span class="d-block">Tournament</span></Link>
                                    <Link to="/not-have-squad"><img src={squad1} alt="squad-1"/><span class="d-block">Squad</span></Link>
